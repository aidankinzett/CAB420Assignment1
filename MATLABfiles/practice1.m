...
Xte_2 = [ ones(size(Xte,1) ,1) , Xte , Xte.^2];
...
disp('Training MSE of order 2 regression')
tr_err = mse(learner,Xtr_2,Ytr)
disp('Testing MSE of order 2 regression')
te_err = mse(learner,Xte_2, Yte)
disp('MAE for order 2 regression')
te_mae = mae(learner,Xte_2, Yte)
